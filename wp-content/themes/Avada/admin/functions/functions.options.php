...
// Theme Specific Options
        ...
        $of_options[] = array( "name" => "Google Maps Geocoding API Key (Optional)",
            "desc" => "Only enter an API key if maps are not already working. <a href='http://theme-fusion.com/knowledgebase/registering-google-map-api-key/'>Click here to learn how to register an API key</a>.",
